...
class WebhookBot extends WickrBot {
    constructor(wickr, url) {
        ...
        this.listen('create', this.create, {description: "Show the webhook URL for this room"});
        this.listen('rekey', this.rekey, {description: "Generate a new webhook URL for this room"});
    }
    ...
    rekey(msg, args) {
        ...
        if (!args) {
            this.send(
                msg.vgroupid,
                '⚠️ This operation will update the webhook URL for this room. ' +
