...
class WebhookBot extends WickrBot {
    constructor(wickr, url) {
        ...
        this.listen('show', this.create.bind(this), {description: "Show the webhook URL for this room"});
