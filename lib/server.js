...
const {formDataParser, chimeParser, attachmentParser, snsParser} = require('./middleware')
...
module.exports = function createServer(bot) {
  ...
  app.post('/send/:key', formDataParser, chimeParser, attachmentParser, snsParser, async (req, res) => {
    try {
